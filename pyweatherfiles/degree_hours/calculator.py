# -*- coding: utf-8 -*-
"""
degree_hours/calculator.py
=============================

:class:`DegreeHoursCalculator` — the core engine of the ``degree_hours``
package: one EPW in, heating/cooling degree-hours out, at any of 4
aggregation frequencies, with setpoints either parsed from a real
EnergyPlus IDF (dual-setpoint thermostats, ``SCHEDULE:COMPACT`` and
...
from ._helpers import (
    ...
    build_24h_profile as _build_24h_profile,
    idf_objects as _idf_objects,
    until_to_hour as _until_to_hour,
)
...
class DegreeHoursCalculator:
    ...
    epw_data : pd.DataFrame
        ...
        the data source used by :class:`~pyweatherfiles.degree_hours.EpwBatchAnalyzer`
        and by :class:`~pyweatherfiles.epw_trend_analyzer.EpwTrendAnalyzer`.
